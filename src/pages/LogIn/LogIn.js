    ...
    return (
      <div className="LogIn">
        <div>
          ...
          />
          <button onClick={this.handleClick} className="buttonLogin" style={{ position:'absolute',right:"650px"}}>התחבר</button>
          <Link to='/Register'>
            <button className="buttonLogin" style={{ position:'absolute',right:"790px"}}>הירשם</button>
          </Link>
        </div>
