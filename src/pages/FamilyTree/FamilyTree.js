...
function FamilyTree(props) {
    ...
    const EditModule = ({nodeDatum}) => (
        <form className="contentModule">
            <label className="LabelPedigree">:שם </label>
            <input 
                id='name' 
                className="InputPedigree" 
                defaultValue={nodeDatum.name}
            />
            <br/>
            <label className="LabelPedigree">:מגדר</label>
            <br/>
            {
            ...
            <br/>
            <br/>
            <label className="LabelPedigree">:תאריך לידה</label>
            <input 
                type='date' 
                className="InputPedigree" 
                id='birth'
            ...
            />} */}
            <label className="LabelPedigree">:תאריך פטירה</label>
            <input 
                id='deathId' 
                disabled={false} 
                type='date' 
            ...
            />
            <br/>
            <label className="LabelPedigree">:אמייל</label>
            <input 
                type='email' 
                className="InputPedigree" 
                id='email'
