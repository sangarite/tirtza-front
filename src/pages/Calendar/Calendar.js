  ...
  render() { 
    ...
    return (
      ...
      <div className="calendarContent"> 
          <h1 className="header">לוח שנה</h1>
          <input
            type='date'
            name='goToPast'
            value={this.state.goToPast}
            onChange={this.onDatePastChange('goToPast')}
            className="InputDatePast"
          />
          <label className="label">בחר תאריך:</label> 
          <br/><br/><br/>
          <button onClick={this.gotoPast} className="button">עבור </button>
          <br/> <br/> <br/> 
          <FullCalendar
            height={'860px'}
          ...
          <ModalBody>
            {
              <form className="form">
                <label className="LableCalendar"  htmlFor="eventName"  >:שם אירוע</label>
                  <br/>
                <input className="InputCalendar" type="text"  placeholder="שם אירוע"  name="eventName"  onChange={this.inputChange}  id="eventName" required/>
                <br/>
                <br/>
                <label className="LableCalendar"  htmlFor="fromDate">:תאריך </label>
                <br/>
                <input className="InputCalendar" type="text" placeholder="Enter from date" name="fromDate" onChange={this.inputChange} id="fromDate" />
                <br/>
              </form> 
            }
          </ModalBody>
          <ModalFooter style={{marginRight:'280px'}}>
            <button  onClick={this.checkValidity} className="button">
              הוסף
            </button>
